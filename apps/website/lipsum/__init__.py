...
_DEFAULT_SAMPLE = pkg_resources.resource_string('website.lipsum', 'data/sample.txt')

_DEFAULT_DICT = pkg_resources.resource_string('website.lipsum', 'data/dictionary.txt').split()
